# Yield Equilibrium Protocol (YEP) Integration Notice
...
$$\text{MAR} = C_v + \left(\frac{C_f}{n}\right)$$

**Where:**
* **$C_v$** = Variable Cost Per Occupied Room (CPOR baseline housekeeping, utilities, guest consumables)
* **$C_f$** = Total Fixed Daily Operating Costs
...
* **Reference Evidence:** [SSRN Research Paper Abstract 6689538](https://ssrn.com)
