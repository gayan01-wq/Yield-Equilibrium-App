...
# --- 4. MARKET INTEL ---
intel_db = {
    "salalah": {"ev": "Khareef Monsoon Festival", "fl": "High Rotations (Dubai/Muscat)", "news": ["Port: Operations stable.", "Tourism: Arrivals surge expected.", "Weather: Monsoon rising."], "basis": "Microclimate Compression"},
    "dubai": {"ev": "DIFC Expansion Summit", "fl": "DXB Slot Scarcity 100%", "news": ["BREAKING: UAE exiting OPEC May 1st.", "DIFC Growth: 775 new companies in Q1.", "Market: Oil volatility driving demand."], "basis": "Energy Hub Velocity"},
...
def draw_seg(label, key, suggest_adr, floor_def, color, is_ota=False, group=False):
    ...
    with c_in:
        ...
        r1, r2, r4, r5 = st.columns([1,1,1.5,1.5])
