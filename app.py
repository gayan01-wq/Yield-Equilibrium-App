...
<style>
    ...
    .pricing-row { background-color: #f1f4f9; padding: 10px; border-radius: 8px; margin-top: 8px; border: 1px solid #1e3799; }
...
with st.sidebar:
    ...
    m_map = {"RO":0.0, "BB":m_bb, "HB":m_bb+m_dn, "FB":m_bb+m_ln+m_
