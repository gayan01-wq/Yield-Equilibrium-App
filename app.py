...
<style>
    ...
    .pricing-row { background-color: #f1f4f9; padding: 10px; border-radius: 10px; margin-top: 8px; border: 1px dashed #1e3799; }
...
def calc_w(rms, adr, n, meals, comm, fl, mice=0.0, trans=0.0):
    ...
    total_segment_wealth = (unit_w * tot_rms * n) + (trans / tx)
    disp_u_w = total_segment_wealth / (tot_rms * n)
    if crisis_active:
