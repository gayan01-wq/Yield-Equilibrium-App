...
with c_a:
    st.markdown(f"<div class='theory-card'><b>🏗️ Pillar 01: Internal Wealth Stripping</b><br>Wealth stripping via Tax (**{tx_div}**), segment-specific Commissions (**OTA only**), and specialized costs.</div>", unsafe_allow_html=True)
with c_b:
    st.markdown(f"<div class='theory-card'><b>🌐 Pillar 02: External Velocity</b><br>ADW Pace vs Benchmark multiplier (**{v_mult}x**). Market News & Aviation tabs substantiate decisions.</div>", unsafe_allow_html=True)
st.markdown("</div>", unsafe_allow_html=True)

# --- 8. FOOTER CONTACT FORM ---
st.markdown("<div class='contact-section'>", unsafe_allow_html=True)
st.subheader("✉️ Contact the System Developer")
st.write("Direct queries to Gayan Nugawela regarding logic or custom features.")
...
with col2:
    ...
    * **Scope:** Algorithm updates, Displacement logic tweaks, Currency/Market updates.
    """)
st.markdown("</div>", unsafe_allow_html=True)
