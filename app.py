...
with st.sidebar:
    ...
    if st.button("🔒 Logout"): st.session_state["auth_key"] = False; st.rerun()

# --- 4. ENGINE (Hardened Formulae) ---
...
st.markdown("<div class='definition-box'><b>The Yield Equilibrium Framework:</b> Calculating <b>Real Bankable Wealth</b> by stripping taxes, commissions, and variable meal allocations.</div>", unsafe_allow_html=True)
st.divider()
...
# Final Footer with Integrity Calculation
if all_res:
    ...
    st.warning("Enter occupancy data to calculate Total Portfolio Bottom Line.")
